...
import { Mail, User, Calendar, Eye, Trash2, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
const Forms = () => {
  const [submissions, setSubmissions] = useState([
    {
      ...
      message: 'We are looking for comprehensive test automation services for our web application...',
  ...
  const stats = [
    ...
    {
      title: 'Contact Forms',
      value: submissions.filter(s => s.type === 'Contact Form').length.toString(),
      change: '+1 today',
      icon: User,
    ...
    {
      title: 'Demo Requests',
      value: submissions.filter(s => s.type === 'Demo Request').length.toString(),
      change: '+2 this week',
      icon: Calendar,
      color: 'bg-purple-500'
    }
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Subscribed': return 'bg-emerald-100 text-emerald-800';
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case 'Contact Form': return User;
      case 'Demo Request': return Calendar;
      case 'Free Trial': return CheckCircle;
      case 'Newsletter Signup': return Mail;
      case 'Career Application': return User;
      default: return Mail;
    }
  };
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="bg-green-100 text-green-800 px-4 py-2 rounded-lg flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">Email notifications active</span>
            </div>
          </div>
        </div>
                    ...
                    <tr key={submission.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">{submission.company || 'No company'}</div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {submission.service && (
                          <div className="text-sm text-gray-500">Interest: {submission.service}</div>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{selectedSubmission.type}</p>
                  </div>
                  <div>
                ...
                {selectedSubmission.message && (
                  <div>
                    ...
                    <p className="text-sm text-gray-900 bg-gray-50 p-3 rounded-md">{selectedSubmission.message}</p>
                  </div>
                )}
                ...
                {selectedSubmission.service && (
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{selectedSubmission.service}</p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{selectedSubmission.submitted}</p>
                  </div>
                  <div>
