...
import { Plus, Send, Users, TrendingUp, Mail, Calendar, Eye, Edit, Trash2 } from 'lucide-react';
import AdminLayout from '../../components/admin/AdminLayout';

const Newsletter = () => {
  const [subscribers] = useState([
    { id: 1, email: 'john.doe@example.com', name: 'John Doe', subscribed: '2025-01-15', status: 'Active' },
    { id: 2, email: 'jane.smith@company.com', name: 'Jane Smith', subscribed: '2025-01-14', status: 'Active' },
    { id: 3, email: 'mike.johnson@startup.io', name: 'Mike Johnson', subscribed: '2025-01-13', status: 'Active' },
    { id: 4, email: 'sarah.wilson@tech.com', name: 'Sarah Wilson', subscribed: '2025-01-12', status: 'Unsubscribed' },
  ]);
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="bg-emerald-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors duration-200 flex items-center space-x-2"
          >
                  ...
                  <tr key={campaign.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {campaign.sent ? `Sent: ${campaign.sent}` : 'Not sent yet'}
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {campaign.status === 'Sent' ? (
                        <div className="text-sm">
                          <div className="text-gray-900">{campaign.opens} opens</div>
                          <div className="text-gray-500">{campaign.clicks} clicks</div>
                        </div>
                      ) : (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        <button className="text-emerald-600 hover:text-emerald-900 p-1" title="View">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {subscribers.map((subscriber) => (
                  <tr key={subscriber.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{subscriber.subscribed}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        ...
                        <button className="text-red-600 hover:text-red-900 p-1" title="Remove">
                          <Trash2 className="h-4 w-4" />
                        </button>
                      </div>
                    </td>
