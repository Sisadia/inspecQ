...
import { Plus, Edit, Trash2, Eye, MapPin, Clock, DollarSign, Users } from 'lucide-react';
  ...
  const [jobs, setJobs] = useState([
    {
      ...
      applications: 23,
      posted: '2025-01-10',
      description: 'We are looking for a Senior QA Engineer to join our growing team...'
    },
    {
      id: 2,
      ...
      applications: 15,
      posted: '2025-01-08',
      description: 'Lead our test automation initiatives and mentor junior engineers...'
    },
    {
      id: 3,
      ...
      applications: 0,
      posted: '2025-01-05',
      description: 'Perfect opportunity for a junior QA engineer to grow their career...'
    }
  ]);
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{jobs.filter(job => job.status === 'Active').length}</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{jobs.reduce((sum, job) => sum + job.applications, 0)}</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{jobs.filter(job => job.status === 'Draft').length}</h3>
