        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Schedule a personalized demo with our experts and discover how InspecQ 
              can transform your testing process and improve software quality.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get a personalized experience that shows exactly how InspecQ fits your needs.
            </p>
          </div>
            ...
            {demoTypes.map((demo) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`p-3 rounded-lg ${selectedDemo === demo.id ? 'bg-emerald-600' : 'bg-gray-400'}`}>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Selected Demo Type:</h4>
              <div className="flex items-center space-x-3">
                <div className="bg-emerald-600 p-2 rounded-lg">
                  {React.createElement(demoTypes.find(d => d.id === selectedDemo)?.icon || Monitor, {
            ...
            <p className="text-sm text-gray-500 text-center">
              We'll send you a calendar invite within 24 hours to confirm your demo.
            </p>
          </form>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
            Start exploring InspecQ immediately with our free trial - no demo required.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/free-trial"
