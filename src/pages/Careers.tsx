...
import { Users, MapPin, Clock, DollarSign, CheckCircle, ArrowRight, Heart, Zap, Award } from 'lucide-react';
...
const Careers = () => {
  ...
  const benefits = [
    ...
    },
    {
      icon: Award,
      title: 'Recognition',
      description: 'Performance bonuses, equity options, and peer recognition programs'
    }
  ];
  ...
  const jobs = [
    {
      ...
      description: 'Join our founding team as we build InspecQ from the ground up. Shape our testing processes and help establish our reputation.',
      requirements: ['3+ years QA experience', 'Test automation skills', 'Startup mindset', 'Full-stack testing'],
      posted: '2 days ago'
    },
    {
      id: 2,
      ...
      description: 'Start your QA career with a growing startup. Learn from experienced professionals while contributing to exciting projects.',
      requirements: ['1+ years QA experience', 'Basic automation knowledge', 'Eagerness to learn', 'Team player'],
      posted: '1 week ago'
    },
    {
      id: 3,
      ...
      description: 'Help build relationships with our first clients and ensure their success. Be part of establishing our reputation in the market.',
      requirements: ['2+ years client-facing experience', 'Technical aptitude', 'Excellent communication', 'Startup experience preferred'],
      posted: '3 days ago'
    }
  ];
  ...
  const departments = [
    ...
    { id: 'Engineering', name: 'Engineering', count: jobs.filter(job => job.department === 'Engineering').length },
    { id: 'Security', name: 'Security', count: jobs.filter(job => job.department === 'Security').length },
    { id: 'Management', name: 'Management', count: jobs.filter(job => job.department === 'Management').length },
    { id: 'Sales', name: 'Sales', count: jobs.filter(job => job.department === 'Sales').length }
  ];
  ...
  const culture = [
    ...
    },
    {
      ...
      description: 'Work with talented professionals in a supportive environment that values teamwork and knowledge sharing.',
      image: 'https://images.pexels.com/photos/3184338/pexels-photo-3184338.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      title: 'Continuous Learning',
      description: 'Grow your skills with access to training, conferences, certifications, and mentorship programs.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Join a team of passionate QA professionals dedicated to delivering exceptional 
              software quality. Grow your career while making a real impact.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer competitive benefits and a culture that supports your professional and personal growth.
            </p>
          </div>
      ...
      <section id="open-positions" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find your next opportunity and join our growing team of QA professionals.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Initial Screening</h3>
              <p className="text-gray-600">Phone or video call to discuss your background and interests.</p>
            </div>
            <div className="text-center">
              <div className="bg-emerald-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                3
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Technical Interview</h3>
              <p className="text-gray-600">Technical assessment and discussion with team members.</p>
            </div>
            <div className="text-center">
              <div className="bg-emerald-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                4
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Final Interview</h3>
              <p className="text-gray-600">Meet with leadership team and discuss role expectations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
            Take the next step in your QA career and help us deliver exceptional software quality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => document.getElementById('open-positions')?.scrollIntoView({ behavior: 'smooth' })}
