        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div>
            ...
            <p className='text-xl text-gray-600 mb-8 leading-relaxed'>
              We help startups,companies and growing SaaS teams ship faster, smarter, and bug-free. From functional and automation testing to performance and
              security, we ensure your product is ready to impress your users.
            </p>
