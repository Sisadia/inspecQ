...
import { CheckCircle, TrendingUp, Users, Zap, Star, Code, Shield, Smartphone } from 'lucide-react';
...
const Portfolio = () => {
  ...
  const methodologies = [
    {
      ...
      features: ['Sprint planning', 'Continuous testing', 'Fast feedback loops']
    },
    {
      title: 'Test Automation',
      description: 'Modern automation frameworks for efficient testing',
      features: ['CI/CD integration', 'Regression testing', 'Cross-browser testing']
    },
    {
  ...
  const industries = [
    { name: 'E-commerce', icon: '🛒', description: 'Online stores and marketplaces' },
    { name: 'FinTech', icon: '💰', description: 'Financial applications and platforms' },
    { name: 'HealthTech', icon: '🏥', description: 'Healthcare and medical software' },
    { name: 'EdTech', icon: '🎓', description: 'Educational platforms and tools' },
    { name: 'SaaS', icon: '☁️', description: 'Software as a Service platforms' },
    { name: 'Startups', icon: '🚀', description: 'Early-stage and growing companies' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We bring deep technical expertise and proven methodologies to deliver 
            exceptional quality assurance for your projects.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          {expertise.map((area, index) => (
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group">
              <div className="p-8">
                <div className={`${area.color} w-12 h-12 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  <area.icon className="h-6 w-6 text-white" />
                </div>
                
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors duration-200">{area.title}</h3>
                <p className="text-gray-600 mb-6">{area.description}</p>
                
                <div className="space-y-2">
                  <h4 className="font-semibold text-gray-900 text-sm">Technologies:</h4>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We follow industry best practices and modern methodologies to ensure comprehensive quality assurance.
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ready to work with companies across various industries and verticals.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-12 text-center text-white">
          ...
          <p className="text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
            Join us as we launch our QA agency. Get premium testing services at startup-friendly rates 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-emerald-600 transition-colors duration-200">
